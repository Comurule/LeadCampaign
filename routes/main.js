...
const { 
    createLead, updateLead, deleteLead, getAllLeads, getLead, getCreateLead, getUpdateLead
...
const { 
    ...
    getPreference, getAllPreference, getCreatePreference, getUpdatePreference
...
//LEAD PREFERENCE ROUTES

router.get('/leadPreference/:leadPreferenceId/update', updateLeadPreference);
